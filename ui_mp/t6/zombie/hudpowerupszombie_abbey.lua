...
CoD.PowerUps.ClientFieldNames[1] = {
	...
	material = RegisterMaterial( "specialty_giant_instakill_zombies" )
}
CoD.PowerUps.ClientFieldNames[2] = {
	clientFieldName = "powerup_double_points",
	material = RegisterMaterial( "specialty_giant_doublepoints_zombies" )
}
CoD.PowerUps.ClientFieldNames[3] = {
	clientFieldName = "specialty_giant_firesale_zombies",
	material = RegisterMaterial( "specialty_giant_firesale_zombies" )
}
CoD.PowerUps.ClientFieldNames[4] = {
	clientFieldName = "powerup_mini_gun",
	material = RegisterMaterial( "t7_hud_zm_powerup_giant_deathmachine" )
}
CoD.PowerUps.ClientFieldNames[5] = {
	clientFieldName = "powerup_crossbow",
	material = RegisterMaterial( "specialty_giant_crossbow_zombies" )
}
CoD.PowerUps.ClientFieldNames[6] = {
	clientFieldName = "powerup_crossbow_up",
	material = RegisterMaterial( "specialty_giant_crossbow_zombies" )
}
