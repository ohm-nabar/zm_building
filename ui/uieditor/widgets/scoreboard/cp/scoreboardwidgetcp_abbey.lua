...
require("ui.uieditor.widgets.HUD.blood_generator")
...
CoD.ScoreboardWidgetCP.new = function (HudRef, InstanceRef)
	...
	f3_local1:setLeftRight(true, false, 40, 845.5)
	f3_local1:setTopBottom(true, false, -8, 29)
	...
	f3_local2:setLeftRight(true, false, 40.5, 866.5)
	f3_local2:setTopBottom(true, false, 29, 533)
	f3_local2.Team1:setVerticalCount(4)
	...
	BGenerator:setLeftRight(true, false, 467, 607)
	BGenerator:setTopBottom(true, false, -140, 0)
	...
	Widget.clipsPerState = {DefaultState = {DefaultClip = function ()
		...
		Widget.BGenerator:setAlpha(0)
		Widget.clipFinished(BGenerator, {})
	end, Intro = function ()
