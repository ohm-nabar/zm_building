...
CoD.ScoreboardHeaderWidgetCP.new = function (HudRef, InstanceRef)
	...
	f1_local2.Text:setText(Engine.Localize("ZM_ABBEY_SB_POINTS"))
	...
	f1_local3.Text:setText(Engine.Localize("ZM_ABBEY_SB_KILLS"))
	...
	f1_local4.Text:setText(Engine.Localize("ZM_ABBEY_SB_DOWNS"))
	...
	f1_local5.Text:setText(Engine.Localize("ZM_ABBEY_SB_REVIVES"))
	...
	f1_local6.Text:setText(Engine.Localize("ZM_ABBEY_SB_HEADSHOTS"))
