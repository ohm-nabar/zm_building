...
function CoD.ZMScr.new(HudRef, InstanceRef)
	...
	Elem:setTopBottom(true, false, -64, 64)
	Elem:makeFocusable()
	...
	listingUser:setTopBottom(true, false, 43.000000, 101.000000)
	...
	listing2:setTopBottom(true, false, 6, 64)
	...
	listing3:setTopBottom(true, false, -29, 29)
	...
	listing4:setTopBottom(true, false, -63, -5)
	...
	zmScrPlusPoints0:setLeftRight(true, false, 1079, 1164)
	zmScrPlusPoints0:setTopBottom(true, false, 59.250000, 125.000000)
	...
	zmScrPlusPoints1:setLeftRight(true, false, 1079, 1164)
	zmScrPlusPoints1:setTopBottom(true, false, 14.250000, 80.000000)
	...
	zmScrPlusPoints2:setLeftRight(true, false, 1079, 1164)
	zmScrPlusPoints2:setTopBottom(true, false, -31.250000, 35.000000)
	...
	zmScrPlusPoints3:setLeftRight(true, false, 1079, 1164)
	zmScrPlusPoints3:setTopBottom(true, false, -76.250000, -10.000000)
