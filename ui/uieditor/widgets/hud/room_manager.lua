...
function CoD.RoomManager.new(HudRef, InstanceRef)
    ...
    local RoomLookup = {"ZM_ABBEY_ROOM_CRASH_SITE", "ZM_ABBEY_ROOM_RED_ROOM", "ZM_ABBEY_ROOM_BELL_TOWER", "ZM_ABBEY_ROOM_RADIO_GALLERY", "ZM_ABBEY_ROOM_SCAFFOLDING", "ZM_ABBEY_ROOM_CHOIR", "ZM_ABBEY_ROOM_CENTRE", "ZM_ABBEY_ROOM_BASILICA", "ZM_ABBEY_ROOM_AIRFIELD", "ZM_ABBEY_ROOM_DORMITORY", "ZM_ABBEY_ROOM_CLOITRE", "ZM_ABBEY_ROOM_MERVEILLE", "ZM_ABBEY_ROOM_GUARD_TOWER", "ZM_ABBEY_ROOM_COURTYARD", "ZM_ABBEY_ROOM_COURTROOM", "ZM_ABBEY_ROOM_VERITE_LIBRARY", "ZM_ABBEY_ROOM_LOWER_PILGRIMAGE", "ZM_ABBEY_ROOM_CATWALK", "ZM_ABBEY_ROOM_BRIDGE", "ZM_ABBEY_ROOM_URM_LABORATORY", "ZM_ABBEY_ROOM_UPPER_PILGRIMAGE", "ZM_ABBEY_ROOM_MIDDLE_PILGRIMAGE", "ZM_ABBEY_ROOM_BRIDGE_V2", "ZM_ABBEY_ROOM_KNIGHTS_HALL", "ZM_ABBEY_ROOM_NO_MANS_LAND"}
