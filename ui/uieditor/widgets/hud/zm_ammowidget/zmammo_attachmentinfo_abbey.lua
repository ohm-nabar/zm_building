...
CoD.ZmAmmo_AttachmentInfo.new = function ( menu, controller )
	...
	AttachmentInfoFireRate:setTopBottom( false, true, -7, 9 )
	...
	AttachmentInfoFireRate:subscribeToModel(Engine.GetModel(Engine.GetModelForController(InstanceRef), "CurrentWeapon.weaponName"), function ( model )
