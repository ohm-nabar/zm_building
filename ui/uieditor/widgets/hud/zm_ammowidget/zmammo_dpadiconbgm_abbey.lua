...
CoD.ZmAmmo_DpadIconBgm.new = function ( menu, controller )
	...
	IconImgBgmBaseInvalid:setLeftRight( false, false, -63, 52 )
	IconImgBgmBaseInvalid:setTopBottom( false, false, -36, 54 )
	...
	IconImgBgmBaseNew:setLeftRight( false, false, -58, 48 )
	IconImgBgmBaseNew:setTopBottom( false, false, -27, 58 )
