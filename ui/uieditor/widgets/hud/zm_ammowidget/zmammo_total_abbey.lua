...
CoD.ZmAmmo_Total.new = function ( menu, controller )
	...
	TotalGlowMult:setTopBottom( true, false, 6, 71 )
	...
	TotalGlow:setTopBottom( true, false, 6, 71 )
	...
	Total:setLeftRight( true, false, 6, 71 )
	Total:setTopBottom( true, false, 6.5, 49.5 )
