...
CoD.ZmAmmo_Total.new = function ( menu, controller )
	...
	TotalGlow:setLeftRight( true, false, 5.71, 81.49 )
	...
	TotalGlowTop:setLeftRight( true, false, 10.8, 65.8 )
	...
	Total:setLeftRight( true, false, 6.71, 72.9 )
	Total:setTopBottom( true, false, 7.5, 51.5 )
	...
	self.clipsPerState = {
		DefaultState = {
			...
			AmmoPickup = function ()
				...
				Total:completeAnimation()
				self.Total:setLeftRight( true, false, 6.71, 72.9 )
				self.Total:setTopBottom( true, false, 7.5, 51.5 )
				self.Total:setRGB( 1, 0.99, 0.93 )
