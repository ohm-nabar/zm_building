    ...
    local function IconDpadAvailable(ModelRef)
        ...
        if NotifyData then
            if NotifyData == 0 then
				Number0:setRGB(0.5, 0.5, 0.5)
				Number1:setRGB(0.5, 0.5, 0.5)
				Number2:setRGB(0.5, 0.5, 0.5)
				Number3:setRGB(0.5, 0.5, 0.5)
				Number4:setRGB(0.5, 0.5, 0.5)
				Number5:setRGB(0.5, 0.5, 0.5)
                SymbolZ:setRGB(0.5, 0.5, 0.5)
                SymbolCross:setRGB(0.5, 0.5, 0.5)
			else
				Number0:setRGB(1, 1, 1)
				Number1:setRGB(1, 1, 1)
				Number2:setRGB(1, 1, 1)
				Number3:setRGB(1, 1, 1)
				Number4:setRGB(1, 1, 1)
				Number5:setRGB(1, 1, 1)
                SymbolZ:setRGB(1, 1, 1)
                SymbolCross:setRGB(1, 1, 1)
            end
        end
    end
	Number0:subscribeToModel(Engine.GetModel(Engine.GetModelForController(InstanceRef), "abbeyDpadAvailable"), IconDpadAvailable)
