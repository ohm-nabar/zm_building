...
CoD.ZmAmmo_BBGumMeterWidget.new = function (HudRef, InstanceRef)
	...
	f1_local2:setTopBottom(true, false, 6, 59)
	...
	f1_local3:setTopBottom(true, false, 6, 59)
	...
	f1_local4:setTopBottom(true, false, 6, 59)
	...
	f1_local5:setTopBottom(true, false, 6, 59)
	...
	f1_local6:setTopBottom(true, false, 6, 58.88)
	...
	f1_local7:setTopBottom(true, false, 6, 58.88)
	...
	f1_local8:setTopBottom(true, false, 14, 50)
	...
	Widget.clipsPerState = {DefaultState = {DefaultClip = function ()
		...
		Widget.BBGumTexture:setTopBottom(true, false, 14, 50)
