...
CoD.ZmAmmo_Clip.new = function ( menu, controller )
	...
	ClipGlow:setLeftRight( true, false, -25.39, 113.39 )
	ClipGlow:setTopBottom( true, false, -17, 69.5 )
	ClipGlow:setRGB( 0.54, 0.01, 0.01 ) -- 1.14, 1.27, 1.44
	...
	ClipGlowTop:setRGB( 0.62, 0.01, 0.01 )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				self.ClipGlow:setRGB( 0.54, 0.01, 0.01 )
				self.clipFinished( ClipGlow, {} )
				ClipGlowTop:completeAnimation()
				self.ClipGlowTop:setRGB( 0.62, 0.01, 0.01 )
		...
		LowAmmo = {
			...
			DefaultState = function ()
				...
				local ClipGlowFrame2 = function ( ClipGlow, event )
					...
					ClipGlow:setRGB( 0.54, 0.01, 0.01 )
					if event.interrupted then
