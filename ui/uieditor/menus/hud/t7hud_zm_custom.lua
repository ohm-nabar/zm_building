...
require("ui.uieditor.widgets.HUD.trial_upgrade_text")
...
function LUI.createMenu.T7Hud_zm_factory(InstanceRef)
    ...
    local TrialUpgradeTextWidget = CoD.TrialUpgradeText.new(HudRef, InstanceRef)
    HudRef:addElement(TrialUpgradeTextWidget)
