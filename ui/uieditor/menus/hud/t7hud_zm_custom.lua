...
require("ui.uieditor.widgets.HUD.gargoyle_dialogue")
...
function LUI.createMenu.T7Hud_zm_factory(InstanceRef)
    ...
    local GargoyleDialogueWidget = CoD.GargoyleDialogue.new(HudRef, InstanceRef)
    HudRef:addElement(GargoyleDialogueWidget)
