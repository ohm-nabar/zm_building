...
function start_fire_sale(item)
{
	...
	{
		level.zombie_vars["zombie_powerup_fire_sale_time"] = level.zombie_vars["zombie_powerup_fire_sale_time"] + 36.5;
		return;
	}
	...
	level.zombie_vars["zombie_powerup_fire_sale_time"] = 36.5;
	if(bgb::is_team_enabled("zm_bgb_temporal_gift"))
	{
		level.zombie_vars["zombie_powerup_fire_sale_time"] = 73;
	}
