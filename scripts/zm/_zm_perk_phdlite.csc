...
function enable_custom_perk_for_level()
{
	...
	zm_perks::register_perk_clientfields( PERK_PHD_LITE, &custom_perk_client_field_func, &custom_perk_callback_func );
	zm_perks::register_perk_effects( PERK_PHD_LITE, PHD_LITE_MACHINE_LIGHT_FX );
	zm_perks::register_perk_init_thread( PERK_PHD_LITE, &init_custom_perk );
}
...
{
	clientfield::register( "clientuimodel", PERK_CLIENTFIELD_PHD_LITE, VERSION_SHIP, 2, "int", undefined, !CF_HOST_ONLY, CF_CALLBACK_ZERO_ON_NEW_ENT );
}
