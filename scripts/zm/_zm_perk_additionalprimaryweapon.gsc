...
{	
	...
	zm_perks::register_perk_basic_info( PERK_ADDITIONAL_PRIMARY_WEAPON, "additionalprimaryweapon", 2500, &"ZOMBIE_PERK_ADDITIONALPRIMARYWEAPON", GetWeapon( ADDITIONAL_PRIMARY_WEAPON_PERK_BOTTLE_WEAPON ) );
