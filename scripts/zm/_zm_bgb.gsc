...
{
	statstablename = "gamedata/weapons/zm/zm_levelcommon_bgb.csv";
	...
	for(i = 0; i < keys.size; i++)
	{
		...
		level.bgb[keys[i]].item_index = Int(row[1]);
		level.bgb[keys[i]].rarity = Int(row[4]);
		...
		level.bgb[keys[i]].camo_index = Int(row[2]);
		/*
