...
function register_clientfields()
{
	...
	clientfield::register( "clientuimodel", "zmhud.swordEnergy", VERSION_SHIP, 1, "float" ); // energy: 0 to 1
	clientfield::register( "clientuimodel", "zmhud.swordState", VERSION_SHIP, 1, "int" ); // state: 0 = hidden, 1 = charging, 2 = ready, 3 = inuse, 4 = unavailable (grey), 5 = ele-charging, 6 = ele-ready, 7 = ele-inuse,
