...
#define ELECTRIC_CHERRY_DOWNED_ATTACK_DAMAGE 6500
#define ELECTRIC_CHERRY_DOWNED_ATTACK_POINTS 40
// Reload Attack
#define RELOAD_ATTACK_MIN_RADIUS 100
#define RELOAD_ATTACK_MAX_RADIUS 200
#define RELOAD_ATTACK_MIN_DAMAGE 1
#define RELOAD_ATTACK_MAX_DAMAGE 2000 // Max damage = a lot
...
{	
	...
	zm_perks::register_perk_basic_info( PERK_ELECTRIC_CHERRY, "electric_cherry", ELECTRIC_CHERRY_PERK_COST, &"ZM_ABBEY_PERK_ELECTRIC_CHERRY_RED", GetWeapon( ELECTRIC_CHERRY_PERK_BOTTLE_WEAPON ) );
