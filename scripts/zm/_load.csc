...
function register_clientfields()
{
	...
	clientfield::register( "clientuimodel", "zmhud.swordEnergy", VERSION_SHIP, 1, "float", undefined, !CF_HOST_ONLY, !CF_CALLBACK_ZERO_ON_NEW_ENT );
	clientfield::register( "clientuimodel", "zmhud.swordState", VERSION_SHIP, 1, "int", undefined, !CF_HOST_ONLY, !CF_CALLBACK_ZERO_ON_NEW_ENT );
