...
#precache("fx", "dlc5/tomb/fx_portal_ice_brick_flash");
#precache("fx", "dlc5/tomb/fx_portal_ice_brick_glow");
#precache("fx", "dlc5/tomb/fx_portal_fire_brick_flash");
#precache("fx", "dlc5/tomb/fx_portal_fire_brick_glow");
#precache("fx", "dlc5/tomb/fx_portal_elec_brick_flash");
#precache("fx", "dlc5/tomb/fx_portal_elec_brick_glow");
#precache("fx", "dlc5/tomb/fx_portal_air_brick_flash");
#precache("fx", "dlc5/tomb/fx_portal_air_brick_glow");
#precache("fx", "dlc5/tomb/fx_portal_generic_brick_dust");
#precache("fx", "dlc5/tomb/fx_portal_air");
#precache("fx", "dlc5/tomb/fx_teleport_3p");
#precache("fx", "dlc5/tomb/fx_portal_air_koentje");
#precache("fx", "dlc5/tomb/fx_portal_elec_koentje");
#precache("fx", "dlc5/tomb/fx_portal_fire_koentje");
#precache("fx", "dlc5/tomb/fx_portal_ice_koentje");
...
function teleporter_init()
{
	...
	clientfield::register("toplayer", "player_rumble_and_shake", 21000, 5, "int");
...
function teleporter_samantha_chamber_line()
{
	...
	level flag::wait_till("initial_blackscreen_passed");//level flag::wait_till("samantha_intro_done");
...
function run_chamber_exit(n_enum)
{
	...
	s_activate_pos.trigger_stub set_unitrigger_hint_string("Hold ^3[{+activate}]^7 to access Teleporter");
	...
	while(true)
	{
		...
		thread rumble_nearby_players(e_fx.origin, 1000, 2);
...
function run_chamber_entrance_teleporter()
{
	...
	self.trigger_stub = tomb_spawn_trigger_radius(self.origin - vectorscale((0, 0, 1), 30), 50);
	...
	while(true)
	{
		...
		thread whirlwind_rumble_nearby_players(str_building_flag);
		if(isdefined(var_ff7119bc))
		{
			//IPrintLnBold("playing specific portal anim");
			e_model thread scene::play(var_ff7119bc, e_model);
		}
		e_model playloopsound("zmb_teleporter_loop_pre", 1);
		wait(open_time);
		//IPrintLnBold("playing 1frame bundle");
